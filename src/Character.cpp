...
Character::Character( std::shared_ptr<Character::ICharacterHolder> aPlace, const Area& aHitArea ) : 
...
void Character::update( long ms, const std::vector< std::shared_ptr<Bullet> >& bullets, const std::vector< std::shared_ptr<Explosion>>& explosions ) {		
